Codebook
========
Codebook was generated on 2015-01-25 14:10:31 during the same process that generated the dataset. See `run_analysis.md` or `run_analysis.html` for details on dataset creation.
...
```r
write.table(dtTidy, file="DatasetHumanActivityRecognitionUsingSmartphones.txt", row.names=FALSE, sep="\t")
```
